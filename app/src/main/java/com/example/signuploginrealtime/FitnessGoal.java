...
public class FitnessGoal extends AppCompatActivity {
    ...
    private String gender, fitnessLevel;
    private int age;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardMuscleGain.setOnClickListener(v -> {
            selectedFitnessGoal = "Muscle Gain";
            updateCardSelection();
        });

        cardEndurance.setOnClickListener(v -> {
            selectedFitnessGoal = "Endurance";
            updateCardSelection();
        });

        cardGeneralFitness.setOnClickListener(v -> {
            selectedFitnessGoal = "General Fitness";
            updateCardSelection();
        });
    ...
    private void updateCardSelection() {
        ...
        switch (selectedFitnessGoal) {
            case "Weight Loss":
                cardWeightLoss.setStrokeColor(getResources().getColor(R.color.black));
                break;
            case "Muscle Gain":
                cardMuscleGain.setStrokeColor(getResources().getColor(R.color.black));
                break;
            case "Endurance":
                cardEndurance.setStrokeColor(getResources().getColor(R.color.black));
                break;
            case "General Fitness":
                cardGeneralFitness.setStrokeColor(getResources().getColor(R.color.black));
                break;
        }
